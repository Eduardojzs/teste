...
def cria_livro(titulo, autor, ano):
...
livro = cria_livro( '1984',  'George Orwell',  1949)


def exibir_livro(livro_adicionado):


    print(f'Autor: {livro_adicionado["autor"]}')
    print(f'titulo: {livro_adicionado["titulo"]}')
    print(f'ano: {livro_adicionado["ano"]}')
