...
print('a) Qual é a sequência resultante C após a concatenação?')
print(c)
print() 

print ('b) Qual é a sequência D após repetir a sequência A três vezes?')
print(d)
print()

print ('c) O número 2 está presente na sequência E?')
print(verificação)