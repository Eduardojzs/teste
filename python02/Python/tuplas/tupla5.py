...
avaliação_de_5_estrelas = avaliacoes.count(5)
avaliação_de_1_estrela = avaliacoes.index(1)+1
print('a) Quantas avaliações de 5 estrelas o filme recebeu?')
print(f'5 Estrelas foi repetida {avaliação_de_5_estrelas} vezes')
print()
print('b) Qual é a posição da primeira avaliação de 1 estrela?')

print(f'A primeira avaliação de 1 estrela foi {avaliação_de_1_estrela}')